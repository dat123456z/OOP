...
public class AddExpense {
    public static void AddExpense(DefaultTableModel model, Connection conn, JFrame frame, JTextField propertyLabel) {
        // Danh sách category
        ...
        if (option == JOptionPane.OK_OPTION) {
            ...
            while (category.equals("Category")) {
                ...
                int retry = JOptionPane.showConfirmDialog(frame, message, "Add New Expense",
